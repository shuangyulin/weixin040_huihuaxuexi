          ...
          <el-form-item class="input" v-if="ruleForm.bianhao" label="编号" prop="bianhao">
              <el-input v-model="ruleForm.bianhao" 
                placeholder="编号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="作业类型" prop="zuoyeleixing">
          <el-input v-model="ruleForm.zuoyeleixing" 
              placeholder="作业类型" clearable  :readonly="ro.zuoyeleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="作业类型" prop="zuoyeleixing">
              <el-input v-model="ruleForm.zuoyeleixing" 
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `zuoyeleixing/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zuoyeleixingCrossAddOrUpdateFlag = false;
                  this.parent.search();
