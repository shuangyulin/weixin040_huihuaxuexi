  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(25, 169, 123, 1);fontSize:28px;">绘画学习平台小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机" type="text" />
																								...
																								<!-- <div v-if="tableName=='jiangshi'" class="input-group">
			   <div class="label">工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.gonghao" class="input" type="text" placeholder="工号">
			   </div>
			 </div> -->
			<el-form-item label="工号" class="input" v-if="tableName=='jiangshi'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='jiangshi'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='jiangshi'" class="input-group">
			...
			<el-form-item label="教师姓名" class="input" v-if="tableName=='jiangshi'">
			...
			<el-form-item label="班级" class="input" v-if="tableName=='jiangshi'">
			  <el-input v-model="ruleForm.banji" autocomplete="off" placeholder="班级" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='jiangshi'" class="input-group">
			...
			<el-form-item label="电话" class="input" v-if="tableName=='jiangshi'">
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.gonghao) && `jiangshi` == this.tableName){
        this.$message.error(`工号不能为空`);
        return
      }
                                                                  if((!this.ruleForm.mima) && `jiangshi` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
                                                                                                                                                                                                                                                                                                                  if(`jiangshi` == this.tableName && this.ruleForm.dianhua&&(!this.$validate.isMobile(this.ruleForm.dianhua))){
