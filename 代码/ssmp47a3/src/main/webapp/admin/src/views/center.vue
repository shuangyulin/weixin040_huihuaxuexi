     ...
     <el-row>
        ...
        <el-form-item   v-if="flag=='xuesheng'"  label="手机" prop="shouji">
          <el-input v-model="ruleForm.shouji"               placeholder="手机" clearable></el-input>
                                                ...
                                                <el-col :span="12">
        <el-form-item   v-if="flag=='jiangshi'"  label="工号" prop="gonghao">
          <el-input v-model="ruleForm.gonghao" readonly              placeholder="工号" clearable></el-input>
        </el-form-item>
      </el-col>
                                          <el-col :span="12">
        <el-form-item   v-if="flag=='jiangshi'"  label="教师姓名" prop="jiaoshixingming">
        ...
        <el-form-item v-if="flag=='jiangshi'"  label="性别" prop="xingbie">
          <el-select v-model="ruleForm.xingbie" placeholder="请选择性别">
            <el-option
                v-for="(item,index) in jiangshixingbieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
                        ...
                        <el-col :span="24">  
        <el-form-item v-if="flag=='jiangshi'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.touxiang?ruleForm.touxiang:''"
          @change="jiangshitouxiangUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='jiangshi'"  label="班级" prop="banji">
          <el-input v-model="ruleForm.banji"               placeholder="班级" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='jiangshi'"  label="电话" prop="dianhua">
...
export default {
  ...
  methods: {
        ...
        this.ruleForm.touxiang = fileUrls;
                                                                                ...
                                                                                jiangshitouxiangUploadChange(fileUrls) {
        this.ruleForm.touxiang = fileUrls;
    },
                                                                                                                            onUpdateHandler() {
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.gonghao)&& 'jiangshi'==this.flag){
        ...
        return
                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                  if( 'jiangshi' ==this.flag && this.ruleForm.dianhua&&(!isMobile(this.ruleForm.dianhua))){
