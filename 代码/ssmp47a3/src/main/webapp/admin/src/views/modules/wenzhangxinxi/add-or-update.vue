  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="文章标题" prop="wenzhangbiaoti">
              <el-input v-model="ruleForm.wenzhangbiaoti" 
                placeholder="文章标题" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.wenzhangtupian" label="文章图片" prop="wenzhangtupian">
          <file-upload
          tip="点击上传文章图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.wenzhangtupian" label="文章图片" prop="wenzhangtupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.wenzhangtupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.wenzhangneirong = this.ruleForm.wenzhangneirong.replace(reg,'../../../ssmp47a3/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
